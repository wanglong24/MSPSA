...
plt.close()
plot_theta.savefig("figure/skewed-quartic-theta-"+str_today+".pdf", bbox_inches='tight')
...
plt.legend(["MSPSA", "Random Search", "Stochastic Ruler"])
plt.close()
plot_loss.savefig("figure/skewed-quartic-loss-"+str_today+".pdf", bbox_inches='tight')
